 ...
 * in a left column, the routed page in the right column, notification bell and
 * sign-out at the top. Pages keep their own <main id="main-content"> so the
    ...
    <div className="grid-container-widescreen">
      ...
      <header className="display-flex flex-justify flex-align-center padding-y-2 border-bottom border-base-lighter">
        ...
        <div className="display-flex flex-align-center">
          {/* Issue #38: workflow notification center */}
          <NotificationBell />
          <button
            type="button"
            className="usa-button usa-button--outline usa-button--small margin-left-2"
            onClick={() => void logout()}
          >
            Sign out
          </button>
