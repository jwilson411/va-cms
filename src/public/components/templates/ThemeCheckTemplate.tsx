/**
 * ThemeCheckTemplate — USWDS / VA theme smoke-test page (issue #17, BRD FR-AUTH-01).
 *
 ...
 * on accent-warm, and Public Sans as the type face. Served at /theme.
 *
 * Server Component — no client-side behaviour. The swatch hexes here are
 * documentation only; the real values live in src/theme/uswds/_va-settings.scss.
 */
...
export function ThemeCheckTemplate(): React.ReactElement {
  return (
    <div className="grid-container" data-testid="theme-check">
